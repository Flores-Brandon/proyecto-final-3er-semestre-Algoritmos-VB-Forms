Public Class BucketSort
    ...
    Private Shared Sub PrintBucketState(ByVal buckets As List(Of Integer)(), ByVal txtBox As TextBox)
    ...
    Public Sub BucketSort_int(ByVal array As Integer(), ByVal txtBox As TextBox)
